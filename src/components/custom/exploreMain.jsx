    ...
    <section className="relative z-10 w-full max-w-5xl mx-auto mt-20 mb-20 px-4 pb-32">
      ...
      <div className="flex flex-col gap-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-[1.5fr_auto] gap-6 items-center">
          ...
          >
            <h3 className="font-tektur text-xl font-semibold mb-3 text-purple-400 underline">
              Project Database
            </h3>
          ...
          >
            <Link href="/ProjectDB">
              <button className="border-2 border-slate-600 hover:border-purple-400 bg-transparent relative z-10 font-tektur px-8 py-3 whitespace-nowrap rounded-lg transition-colors duration-300 text-white">
        ...
        <div className="grid grid-cols-1 md:grid-cols-[auto_1.5fr] gap-6 items-center">
          ...
          >
            <Link href="/recom">
              <button className="border-2 border-slate-600 hover:border-purple-400  bg-transparent relative z-10 font-tektur px-8 py-3 whitespace-nowrap rounded-lg transition-colors duration-300 text-white text-lg">
                <span>Let&apos;s see</span>
              </button>
            </Link>
          </motion.div>
          ...
          >
            <h3 className="font-tektur text-xl font-semibold mb-3 text-purple-400 underline text-right">
